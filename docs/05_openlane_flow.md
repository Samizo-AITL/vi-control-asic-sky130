...
<img
  ...
  alt="OpenLane layout inspection view"
  style="width:80%;"
/>

The figure above shows an **intermediate placed-and-routed layout**
...
It is intended for **flow understanding and inspection**,
not as the final tapeout deliverable.
